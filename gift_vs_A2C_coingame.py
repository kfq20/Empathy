...
if is_wandb:
    wandb.init(project='Empathy', entity='kfq20', name='prosocial vs A2C coingame (test)')
step_time = 0
a2c_time = 0
offline_time = 0
test_time = 0
    ...
    if is_wandb:
        wandb.log({'actor loss': total_actor_loss,
                ...
                #    'hare num':total_hunt_hare_num,
                   ...
                   'episode':ep,
                   'factor_1to2':total_give_factor[0][1].mean(), # 'factor_1to3':total_factor[0][1].mean(), 'factor_1to4':total_factor[0][2].mean(),
                   'factor_2to1':total_give_factor[1][0].mean(), # 'factor_2to3':total_factor[1][1].mean(), 'factor_2to4':total_factor[1][2].mean(),
